...
function [anticycFile cyclonicFile] = findEddies(year, month, day)
    ...
    anticycFile = strcat('/project/expeditions/eddies_project_data/results/ESv1-0829/',...
        'anticyc_', year, month, day, '.mat');
    cyclonicFile = strcat('/project/expeditions/eddies_project_data/results/ESv1-0829/',...
